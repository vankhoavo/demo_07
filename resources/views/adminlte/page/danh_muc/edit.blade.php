            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input value="{{ $data[0]->ma_danh_muc }}" type="text" name="ma_danh_muc" class="form-control"
                            placeholder="Vui lòng điền mã danh mục cần chỉnh sửa">
                    </div>
                    <div class="form-group">
                        <label>Tên Danh Mục</label>
                        <input value="{{ $data[0]->ten_danh_muc }}" type="text" name="ten_danh_muc" class="form-control"
                            placeholder="Vui lòng điền tên danh mục cần chỉnh sửa">
                    </div>
                    <div class="form-group">
